    ...
    public static Map<String, List<Map<String, Object>>> getHomePageContent() {
        List<Map<String, Object>> globalContent = List.of(
                Map.of(
                        ...
                        "props", Map.of(
                                "messages", List.of(
                                        Map.of("id", "msg1", "icon", "fas fa-truck", "text",
                                                "Free Worldwide Shipping on Orders Over $99"),
                                        Map.of("id", "msg2", "icon", "fas fa-tag", "text",
                                                "Summer Sale: Up to 50% Off Selected Items"),
                                        Map.of("id", "msg3", "icon", "fas fa-phone", "text",
                                                "24/7 Customer Support: 1-800-555-HELP")),
                ...
                Map.of(
                        ...
                        "props", Map.<String, Object>ofEntries(
                                ...
                                Map.entry("links", List.of(
                                        ...
                                        Map.of("label", "Contact", "url", "/contact", "type", "internal", "target",
                                                "_self"),
                                        Map.of("label", "About", "url", "/about", "type", "internal", "target",
                                                "_self"))),
                ...
                Map.of(
                        ...
                        "props", Map.of(
                                ...
                                "logoImage", "",
                                "columns", List.of(
                                        Map.of("title", "About Us", "links",
                                                List.of("Our Story", "Careers", "Sustainability", "Press")),
                                        Map.of("title", "Customer Service", "links",
                                                List.of("Contact Us", "Shipping", "Returns", "FAQ")),
                                        Map.of("title", "Social", "links",
                                                List.of("Instagram", "Twitter", "Facebook", "Pinterest"))),
                                "showNewsletter", true,
                                "socialIcons", true,
                                "paymentIcons", true,
                ...
                Map.of(
                        ...
                        "props", Map.<String, Object>ofEntries(
                                Map.entry("slides", List.of(
                                        Map.ofEntries(
                                                Map.entry("backgroundType", "image"),
                                                Map.entry("background",
                                                        "https://res.cloudinary.com/dswnf6mpd/image/upload/v1746274970/t2ordrcpctw46vn81bhi.jpg"),
                                                Map.entry("title", "Elevate Your Lifestyle"),
                                                Map.entry("subtitle",
                                                        "Premium essentials for modern living. Experience quality like never before."),
                                                Map.entry("ctaButtons", List.of(
                                                        Map.of("text", "Shop Now", "variant", "primary"),
                                                        Map.of("text", "Learn More", "variant", "primary"))),
                                                Map.entry("imageWidth", "100%"),
                                                Map.entry("imageHeight", "100%"),
                                                Map.entry("objectFit", "cover"),
                                                Map.entry("objectPosition", "center"),
                                                Map.entry("titleFontSize", "3.5rem"),
                                                Map.entry("titleColor", "#ffffff"),
                                                Map.entry("titleFontWeight", "700"),
                                                Map.entry("titleTextShadow", ""),
                                                Map.entry("subtitleFontSize", "1.5rem"),
                                                Map.entry("subtitleColor", "#dfe1e4"),
                                                Map.entry("subtitleFontWeight", "400"),
                                                Map.entry("subtitleMargin", "1rem 0"),
                                                Map.entry("contentPosition", "center center"),
                                                Map.entry("contentMaxWidth", "800px")),
                                        Map.ofEntries(
                                                Map.entry("backgroundType", "image"),
                                                Map.entry("background",
                                                        "https://res.cloudinary.com/dswnf6mpd/image/upload/v1746275924/gjadawgtmyd8ljqfs0wx.jpg"),
                                                Map.entry("title", "Azan Baloch"),
                                                Map.entry("subtitle", "It's my testing hero section"),
                                                Map.entry("ctaButtons", List.of(
                                                        Map.of("text", "Shop Now", "variant", "primary"))),
                                                Map.entry("imageWidth", "100%"),
                                                Map.entry("imageHeight", "100%"),
                                ...
                                Map.entry("heroOverlay",
                                        "linear-gradient(to bottom, rgba(15, 15, 26, 0.151) 0%, rgba(15, 15, 26, 0.164) 50%, rgba(15, 15, 26, 0.178) 100%)"),
                        ...
                        "props", Map.<String, Object>ofEntries(
                                Map.entry("testimonials", List.of(
                                        Map.of(
                                                ...
                                                "text",
                                                "The quality and style are unmatched. My go-to for seasonal trends!",
                                                "rating", 5,
                                                "image",
                                        ...
                                        Map.of(
                                                ...
                                                "role", "Stylist",
                                                "text",
                                                "Perfect balance of comfort and style. My clients love these pieces.",
                                                "rating", 4,
                                                "image",
